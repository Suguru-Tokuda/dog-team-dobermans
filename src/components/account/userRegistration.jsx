...
class UserRegistration extends Component {
    ...
    constructor(props) {
        super(props);
        if (this.props.history && this.props.history.location.state && this.props.history.location.state.redirectURL)
            this.state.redirectURL = this.props.history.location.state.redirectURL;
    }
    ...
    handleSubmitBtnClicked = async () => {
        ...
        if (isValid === true) {
            ...
            try {
                ...
                user.city = city;
                user.state = state;
                user.emailVerified = user.currentUser.emailVerified;
